...
const callbotmsgs = ['dimension', 'hidra']
...
const antinewchatmsg = 'Olá, sou o bot de whatsapp e meu criador bloqueou me chamar no privado, caso tenha sido removido de algum grupo contate um adm do mesmo para saber o motivo.'
//mensagem do antinewchat

const urlaudiomenu = 'https://g.top4top.io/m_2014t7muu0.mp3'
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO HIDRA-BOT COM 434 COMANDOS, BATERIA: ${battery}`
}
...
const cr = '☄️✨𝑯𝑰𝑫𝑹𝑨 𝑫𝑰𝑴𝑬𝑵𝑺𝑰𝑶𝑵✨☄️\n' 
// texto do simbolo de verificado

const prefix = '!' 
// prefixo

const blockedmsg = '*Seu número esta bloqueado, ou seja não vou te obedecer*'
